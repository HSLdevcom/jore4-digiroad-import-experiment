...
At the moment, there is no specific use for the dump generated with the above command. However, it is planned that a separate schema will be generated later that will contain the infrastructure tables and fields used in JORE4 database.

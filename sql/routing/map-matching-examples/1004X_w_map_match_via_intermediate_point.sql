...
via_points AS (
    ...
    SELECT ARRAY[ ST_GeomFromEWKT('SRID=4326;POINT(24.937233222649102 60.170797646315854)') ] AS geom_arr
),
match_params AS (
    SELECT

...
ALTER TABLE :schema.dr_pysakki ALTER COLUMN valtak_id SET NOT NULL;
...
ALTER TABLE :schema.dr_pysakki ALTER COLUMN sijainti_m SET NOT NULL;
ALTER TABLE :schema.dr_pysakki ALTER COLUMN vaik_suunt SET NOT NULL;
